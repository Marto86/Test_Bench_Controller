...
#define EG915N_EU_VID (0x2c7c)
#define EG915N_EU_PID (0x6002)
#define EG915N_EU_IN_ADDR (0x86)
#define EG915N_EU_OUT_ADDR (0x0F)
#define E3372H_153_STICK_VID (0x12d1)
#define E3372H_153_STICK_PID (0x1506)
#define E3372H_153_STICK_IN_ADDR (0x81)
#define E3372H_153_STICK_OUT_ADDR (0x01)
